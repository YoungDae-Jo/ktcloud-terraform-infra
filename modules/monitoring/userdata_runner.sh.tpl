...
if [ ! -f "${RUNNER_DIR}/config.sh" ]; then
  ...
  log "Installing runner dependencies as root..."
  cd "${RUNNER_DIR}"
...
# ==============================
echo "[monitoring] Installing Docker + Deploying monitoring repo"
...
echo "[monitoring] Clone or update monitoring repo"
if [ ! -d "${DIR}/.git" ]; then
...
echo "[monitoring] Starting docker compose profile=${PROFILE}"
